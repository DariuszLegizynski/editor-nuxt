...
<template>
	<svg ref="iconEmailRef" :width="width" :height="height" fill="none" stroke="black" stroke-linecap="round" viewBox="0 0 24 24">
		<rect ref="iconRectEmail" stroke-dasharray="72px" stroke-dashoffset="72px" width="20" height="16" x="2" y="4" rx="0" />
		<path ref="iconPathEmail" stroke-dasharray="24.413110733032227px" stroke-dashoffset="24.413110733032227px" d="m2 7 10 7 10-7" />
	</svg>
</template> -->
